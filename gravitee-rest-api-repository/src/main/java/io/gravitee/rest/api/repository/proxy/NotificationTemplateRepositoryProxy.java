...
public class NotificationTemplateRepositoryProxy extends AbstractProxy<NotificationTemplateRepository> implements NotificationTemplateRepository {
    ...
    @Override
    public Optional<NotificationTemplate> findById(String id, String referenceId, NotificationTemplateReferenceType referenceType) throws TechnicalException {
        return target.findById(id, referenceId, referenceType);
    }
    ...
    @Override
    public void delete(String id, String referenceId, NotificationTemplateReferenceType referenceType) throws TechnicalException {
        target.delete(id, referenceId, referenceType);
    }
    ...
    @Override
    public Set<NotificationTemplate> findAllByType(NotificationTemplateType type, String referenceId, NotificationTemplateReferenceType referenceType) throws TechnicalException {
        return target.findAllByType(type, referenceId, referenceType);
    }
}
